...
import static util.STATIC.music_volume;
                ...
                switch (args[0].toLowerCase()) {
                    ...
                    case "v":
                        if (args[1] == "+") {
                            ...
                            event.getTextChannel().sendMessage(NOTE + "set volume to: " + music_volume);
                            getPlayer(guild).setVolume(music_volume);
                        }
