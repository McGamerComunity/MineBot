    ...
    public void action(String[] args, MessageReceivedEvent event) {
        ...
        switch (args[0].toLowerCase()) {
                ...
                event.getTextChannel().sendMessage(
                        ...
                        new EmbedBuilder().setColor(Color.GREEN).setDescription(
                                "**USAGE:**\n" +
                                        "**PREFIX**: - " +
                                        "\n" +
                                        STATIC.PREFIX + "music p/play <URL>  ->  Play music \n" +
                                        STATIC.PREFIX + "music queue  ->  Show what song comes next\n" +
                                        STATIC.PREFIX + "music now/Info  ->  Show waht now playing\n" +
                                        STATIC.PREFIX + "music shuffel  ->  play shuffel in the playlist\n" +
                                        STATIC.PREFIX + "music stop  ->  Stop the song\n" +
                                        STATIC.PREFIX + "music skip/s  ->  skip one Song\n"
                        ).build()
                ).complete();
            ...
            case "p":
                ...
                event.getTextChannel().sendMessage("Now Playing:" + args[1]).queue();
